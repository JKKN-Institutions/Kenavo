...
export const ContactInfo: React.FC<ContactInfoProps> = ({ className = "" }) => {
  return (
    <section className={`flex flex-col items-center md:items-start text-white text-center md:text-left ${className}`}>
      <h1 className="text-[rgba(217,81,100,1)] text-[26px] sm:text-[32px] md:text-[38px] lg:text-[44px] xl:text-[50px] font-bold leading-[1.15] sm:leading-[1.2] md:leading-[1.2] lg:leading-[1.2]">
        Who to bug
        <br />
        if something's broken
      </h1>

      <div className="text-[14px] sm:text-[15px] md:text-[15px] lg:text-[16px] xl:text-[17px] font-normal leading-[1.7] lg:leading-[1.75] mt-6 sm:mt-7 md:mt-8 lg:mt-10 xl:mt-12">
      ...
      <address className="text-[14px] sm:text-[15px] md:text-[15px] lg:text-[16px] xl:text-[17px] font-medium leading-[1.7] underline mt-5 sm:mt-6 md:mt-7 lg:mt-9 xl:mt-10 not-italic break-words flex flex-col items-center md:items-start gap-2 lg:gap-3">
