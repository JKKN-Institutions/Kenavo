  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto" style={{ background: 'transparent' }}>
        <div className="gap-3 sm:gap-4 md:gap-5 flex flex-col md:flex-row items-center md:items-center" style={{ background: 'transparent' }}>
          <div className="w-full md:w-[60%] lg:w-[65%] order-1 md:order-2">
            <div className="flex flex-col items-center font-bold text-center">
              <h1
                id="about-heading"
                className="text-[rgba(217,81,100,1)] text-[24px] sm:text-[28px] md:text-[32px] lg:text-[36px] xl:text-[38px] leading-[1.02] sm:leading-[1.02] md:leading-[1.02] lg:leading-[1.02] xl:leading-[1.02]"
              >
                134 boys.
                <br />
                One shared story.
              </h1>
              <p className="text-[rgba(254,249,232,1)] text-[16px] sm:text-[17px] md:text-[18px] lg:text-[18px] xl:text-[19px] leading-[1.2] sm:leading-[1.2] md:leading-[1.2] lg:leading-[1.2] xl:leading-[1.2] mt-1 sm:mt-1 md:mt-1 lg:mt-2 xl:mt-2">
        ...
        <p className="text-[rgba(254,249,232,1)] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[16px] xl:text-[17px] font-normal leading-[1.25] sm:leading-[1.25] md:leading-[1.25] lg:leading-[1.25] xl:leading-[1.25] text-center mt-1 sm:mt-2 md:mt-2 lg:mt-2 xl:mt-3">
